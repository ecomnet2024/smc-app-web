...
import { AssignmentInd, AssignmentIndOutlined, LocalHospital, LocalHospitalOutlined, MedicalInformation, Sick } from "@mui/icons-material";
...
const Sidebar = () => {
    ...
    if (!user) {
      return console.log("Erreur de connexion")
    }
